...
from .views import ConfigureRoleView, MenteeDashboardView, MentorDashboardView, MentorConfigView
...
urlpatterns = [
    ...
    path('mentor-config/',MentorConfigView.as_view(), name='mentor_dashboard'),
]
